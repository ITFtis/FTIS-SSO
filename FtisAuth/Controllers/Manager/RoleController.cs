...
{
    [Dou.Misc.Attr.MenuDef(Name = "角色管理", MenuPath = "系統管理", Action = "Index", Index = 1, Func = Dou.Misc.Attr.FuncEnum.ALL, AllowAnonymous = false)]
    public class RoleController : Dou.Controllers.RoleBaseController<Role>
    {
        ...
        internal static System.Data.Entity.DbContext _dbContext = new FtisAuth.Models.FtisAuthContext();
